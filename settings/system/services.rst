...
Image Service
   ...
   EasyGo Solutions's setup wizard to fetch your company logo based on the domain of the
   ...
   ``images.EasyGo Solutions.com``.

   Default: ``EasyGo Solutions Image Service`` (active)
...
Geo Calendar Service
   ...
   ``geo.EasyGo Solutions.com``.

   Default: ``EasyGo Solutions GeoCalendar Service`` (active)
...
Geo IP Service
   ...
   ``HTTPS`` access to ``geo.EasyGo Solutions.com``.

   Default: ``EasyGo Solutions GeoIP Service`` (active)
