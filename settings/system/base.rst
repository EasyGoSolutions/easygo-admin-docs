...
Fully Qualified Domain Name
   The URL of your EasyGo Solutions installation.
...
SystemID
   ...
   The SystemID is randomly selected upon installation of EasyGo Solutions (``1-99``).

   .. warning::

      **Do not** change this setting in a productive system!
      Your EasyGo Solutions installation may no longer recognize old ticket number based
