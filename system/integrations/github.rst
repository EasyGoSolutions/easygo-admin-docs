...
Use GitHub integration to track GitHub issues directly within EasyGo Solutions tickets.
...
3. Enter your new API token in EasyGo Solutions and enable GitHub integration.
...
Token verification is taking a long time
   ...
   to ensure that your EasyGo Solutions server can reach ``api.github.com``.
