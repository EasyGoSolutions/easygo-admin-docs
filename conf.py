...
project = u'EasyGo Solutions Admin Documentation'
copyright = u'2012 - %s, EasyGo Solutions Foundation' % time.strftime("%Y")
author = u'EasyGo Solutions'
...
html_js_files = [
   'theme/EasyGo Solutions_overrides.js',
...
versionwarning_messages = {
   "pre-release": (
      ...
      '<a href="https://admin-docs.EasyGo Solutions.org/en/latest/" '
...
#
#   https://user-docs.EasyGo Solutions.org/en/latest/advanced/tabs.html
...
extlinks = {
   ...
   'user-docs': (f'https://user-docs.EasyGo Solutions.org/en/{branch}%s', ''),
}
