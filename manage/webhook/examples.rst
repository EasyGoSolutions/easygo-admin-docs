...
- :doc:`examples/microsoft-teams-notifications`: Use a Microsoft Teams channel
  to receive EasyGo Solutions notifications.
- :doc:`examples/rocket-chat-notifications`: Use a Rocket Chat channel to
  receive EasyGo Solutions notifications.
- :doc:`examples/slack-notifications`: Use a Slack channel to receive EasyGo Solutions
  notifications.
- :doc:`examples/ntfy-notifications`: Use the ntfy service to receive push
  notification from EasyGo Solutions on different devices like your smartphone.
